...
public:
     ...
     * 三原色的取值范围都是 [0, 255]。
     */
    static void setCoutColor(int red, int green, int blue) {
     ...
     * 三原色的取值范围都是 [0, 255]。
     */
    static void setClogColor(int red, int green, int blue) {
